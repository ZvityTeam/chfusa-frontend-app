...
export default function GalleryComponentcopy() {
          ...
          {photos.map((photo, index) => (
            ...
            >
              <div className="aspect-[4/3] relative">
                ...
                />
                <div className="absolut e inset-0 bg-black/40 opacity-0 group-hover:opacity-100 transition-opacity duration-300" />
